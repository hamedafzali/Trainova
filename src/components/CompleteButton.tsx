...
export function CompleteButton({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <button
      ref={ref}
      className="relative w-full overflow-hidden rounded-card bg-accentFill py-5 text-base font-bold text-onAccent shadow-elevated transition-transform active:scale-[0.99]"
